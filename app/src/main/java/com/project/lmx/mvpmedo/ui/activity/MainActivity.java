...
import com.project.lmx.sdk.helper.BottomNavigationViewHelper;
import com.project.lmx.sdk.rxbus.RxBus;
import com.project.lmx.sdk.rxbus.Subscribe;
import com.project.lmx.sdk.utils.AppUtils;
import com.project.lmx.sdk.utils.FileUtils;
import com.project.lmx.sdk.utils.NavigationUtils;
import com.project.lmx.sdk.utils.SpUtils;
import com.project.lmx.sdk.utils.ToastUtils;
import com.project.lmx.sdk.widgets.MovingImageView;
import com.project.lmx.sdk.widgets.MovingViewAnimator.MovingState;
import com.project.lmx.mvpmedo.R;
import com.project.lmx.mvpmedo.constant.BundleKeyConstant;
import com.project.lmx.mvpmedo.model.bean.rxbus.RxEventHeadBean;
import com.project.lmx.mvpmedo.ui.activity.detail.WebViewLoadActivity;
import com.project.lmx.mvpmedo.ui.fragment.book.BookRootFragment;
import com.project.lmx.mvpmedo.ui.fragment.gankio.GankIoRootFragment;
import com.project.lmx.mvpmedo.ui.fragment.home.HomeRootFragment;
import com.project.lmx.mvpmedo.ui.fragment.home.child.HomeFragment;
import com.project.lmx.mvpmedo.ui.fragment.movie.MovieRootFragment;
import com.project.lmx.mvpmedo.ui.fragment.personal.PersonalRootFragment;
...
import static com.project.lmx.mvpmedo.constant.HeadConstant.HEAD_IMAGE_NAME;
import static com.project.lmx.mvpmedo.constant.RxBusCode.RX_BUS_CODE_HEAD_IMAGE_URI;
...
public class MainActivity extends BaseCompatActivity implements HomeFragment
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.group_item_github:
                        ...
                        bundle.putString(BundleKeyConstant.ARG_KEY_WEB_VIEW_LOAD_TITLE, "MvpDemo");
                        bundle.putString(BundleKeyConstant.ARG_KEY_WEB_VIEW_LOAD_URL,
                                "https://github.com/liangminxiong/MvpDemo");
                    ...
                    case R.id.group_item_more:
                        ...
                        bundle2.putString(BundleKeyConstant.ARG_KEY_WEB_VIEW_LOAD_URL,
                                "https://github.com/liangminxiong");
    ...
    private void showShare() {
        ...
        oks.setTitle("MvpDemo");
        // titleUrl是标题的网络链接，QQ和QQ空间等使用
        oks.setTitleUrl("https://github.com/liangminxiong/MvpDemo");
        // text是分享文本，所有平台都需要这个字段
        oks.setText("每日新闻，精选干货，最新资讯，应有尽有.项目详情链接：https://github.com/liangminxiong/MvpDemo");
        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
        //oks.setImagePath("/sdcard/test.jpg");//确保SDcard下面存在此张图片
        // url仅在微信（包括好友和朋友圈）中使用
        //由于微信需要注册AppKey才能演示，这里取消微信分享，个人根据自己的需求注册Appkey使用
        oks.setUrl("https://github.com/liangminxiong/MvpDemo");
        // comment是我对这条分享的评论，仅在人人网和QQ空间使用
        oks.setComment("这个App贼好用，快下载体验吧~");
        // site是分享此内容的网站名称，仅在QQ空间使用
        oks.setSite(getString(R.string.app_name));
        // siteUrl是分享此内容的网站地址，仅在QQ空间使用
        oks.setSiteUrl("https://github.com/liangminxiong/MvpDemo");
        // 启动分享GUI
        oks.show(this);
    }
}
